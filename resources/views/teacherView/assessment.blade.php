                                                    ...
                                                    @if ($student->assessment->assessmentType->id === $assessment->assessmentType->id)
                                                        <tr>
                                                            ...
                                                            <td class="align-middle text-center text-uppercase text-sm">
                                                                {{ $student->student->lastname }}</td>
                                                            <td class="align-middle text-center text-uppercase text-sm">
                                                                {{ $student->student->dni }}</td>
                                                            <td class="align-middle text-center  text-sm">
                                                                {{ $student->grade }}</td>
                                                            <td>
                                                                @if ($student->status == 1)
                                ...
                                <div class="col-12">
                                    <div class="input-group input-group-outline me-2">
                                        <select class="form-select" name="id_assessment" required>
                                            ...
                                            @foreach ($assessments as $assessment)
                                                <option class="text-uppercase" value="{{ $assessment->id }}">
                                                    {{ $assessment->assessmentType->assessment_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="input-group input-group-outline me-2">
                                        <select class="form-select" name="id_student" required>
                                            ...
                                            @foreach ($studentInSections as $student)
                                                <option class="text-uppercase" value="{{ $student->id }}">
                                                    {{ $student->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
        ...
        <div class="modal fade" id="AssesstUpdateStudentModal" tabindex="-1" aria-labelledby="AssesstUpdateStudentModal"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form role="form" id='AssesstUpdateStudentModal-form' class="text-start alertEdits"
                        method="POST" action="">
                        @method('PATCH')
                        @csrf
                        <div class="modal-body">
