                            ...
                            <div class="col-xl-3 col-md-6  mb-5 col-sm-4">
                                <div class="card card-blog card-plain">
                                    <div class="card-body p-3 d-flex flex-column">
                                        ...
                                        <div class="text-center">
                                            <a href="{{ route('teacherView.assessment', ['section' => $section->id, 'subject' => $subject->id]) }}"
                                ...
                                <div class="card card-blog card-plain">
                                    <div class="card-body p-3 d-flex flex-column">
                                        ...
                                        <div class="text-center">
                                            <button type="button"
                                                class="btn bg-gradient-danger btn-lg btn-rounded w-100 mt-4 mb-0"
                                                data-bs-toggle="modal" data-bs-target="#modalSelectSchedule">
                                                Seleccionar Horario
                                            </button>
                                        </div>
                                    </div>
...
@section('modals')
    <div class="modal fade" id="modalSelectSchedule" tabindex="-1" aria-labelledby="modalSelectScheduleLabel"
        aria-hidden="true">
                    ...
                    <ul class="list-group">
                        ...
                        @forelse ($schedules as $schedule)
                            <li class="list-group-item">
                                <a
                                    href="{{ route('teacherView.attedance', ['section' => $section->id, 'subject' => $subject->id, 'schedule' => $schedule->id]) }}">
                                    Horario: {{ $schedule->start_datetime }} - {{ $schedule->end_datetime }} | Día:
