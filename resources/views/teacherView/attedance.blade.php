            ...
            <table class="table align-items-center mb-0">
                ...
                <body>
                    ...
                    <tr>
                        ...
                        <td class="align-middle text-uppercase text-center text-sm">{{ $data->studentSections->student->name }}</td>
                        <td class="align-middle text-center text-uppercase text-sm">{{ $data->studentSections->student->lastname }}</td>
                        <td class="align-middle text-center text-uppercase text-sm">{{ $data->studentSections->student->dni }}</td>
                        <td class="align-middle text-center text-uppercase text-sm">{{ $data->studentSections->student->gender }}</td>
                        <td>
                        @if ($data->status == 1)
...
<div class="modal fade" id="ModRegistroAsistencia" tabindex="-1" aria-labelledby="ModRegistroAsistencia" aria-hidden="true">
                ...
                <div class="modal-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <input name="attendance[{{ $student->id }}]" type="checkbox" class="form-check-input" value="0">
                            </div>
                        </li>
                        @empty
