                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 mb-5">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="align-middle text-white text-capitalize ps-3">Periodo
                                {{ $section->school_period->period_name }}:MATERIAS
                            </h6>
                        </div>
                    </div>
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 mb-5">
                    ...
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <a href="{{ route('teacherView.section', $section->school_period->id) }}" type="button"
