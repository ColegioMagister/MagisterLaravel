...
<div class="card my-4">
    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
            <h6 class="text-white text-capitalize ps-3">Periodo: {{$school_period->period_name}} - Secciones</h6>
        </div>
        <div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-uppercase text-sm w-15 pe-4">
                            ...
                            <a class="btn btn-success me-3" href='{{route('sections.show', $section)}}'>
...
<div class="modal fade" id="ModRegSection" tabindex="-1" aria-labelledby="ModRegSection" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <!-- #para que cargue  -->
            <form role="form" class="text-start" method="POST" action="{{route('sections.store', $school_period)}}">
                @csrf
                    ...
                    <div class="input-group input-group-outline mt-2 mb-4">
                        <div class="col-6">
                            <div class="input-group input-group-outline me-2">
                                <input type="hidden" class="form-select" name="id_period" value="{{$school_period->id}}">
                            </div>
                        </div>
