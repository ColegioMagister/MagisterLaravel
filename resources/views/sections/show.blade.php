            ...
            <div class="col-12">
                <div class="card my-4">
                    ...
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        ...
                        <div>
                            <a href="{{ route('sections.index', ['school_period' => $section->school_period]) }}"
                                ...
                                <tbody>
                                    ...
                                    @forelse ($section_students as $student)
                                        <tr>
                                            ...
                                            <td class="text-uppercase text-sm w-15 pe-4">
                                                ...
                                                <button type="submit" class="btn btn-primary ms-3 me-3"
                                                    data-bs-toggle="modal" data-bs-target="#SectionUpdateStudentModal"
                                                    data-url='{{ route('sections.updateStudent', [$section, $student]) }}'
                                                ...
                                                <form class="alertDelete" method="POST"
                                                    action="{{ route('sections.studentDetached', [$section, $student]) }}"
                                        ...
                                        <tr class="empty-table-message">
                                            <td class="w-100" colspan="6">No hay alumnos registrados en esta sección
                                            </td>
                                        </tr>
                                    @endforelse
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-uppercase text-sm w-15 pe-4">
                                                ...
                                                <button type="submit" class="btn btn-primary ms-2 me-2"
                                                    data-bs-toggle="modal" data-bs-target="#SectionUpdateSubjectModal"
                                                    data-url='{{ route('sections.updateSubject', [$section, $subject]) }}'
                                                    data-send="{{ route('sections.getSubjectUpdateAjax', [$section, $subject]) }}">
                                                    <i class="fa-solid fa-chalkboard-user fa-xl"></i> &nbsp; Seleccionar
                                                    profesor
                                                </button>

                                                <a href="{{ route('sections.assessments.index', [$section, $subject]) }}"
                                                    class="btn btn-success ms-2 me-2">
                                                    <i class="fa-solid fa-file-pen fa-xl"></i>
                                                </a>

                                                <form class="alertDelete" method="POST"
                                                    action="{{ route('sections.deleteSubject', [$section, $subject]) }}"
                                                    accept-charset="UTF-8" style="display:inline">
                                                    @method('DELETE')
                                                    @csrf
...
@section('modals')
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form role="form" class="text-start" method="POST"
                    action="{{ route('sections.registerStudent', $section) }}">
                    @csrf
                    ...
                    <div class="modal-body">
                                ...
                                <div class="input-group input-group-outline me-2">
                                    ...
                                    <select class="form-select" name="id_student_section" id="" required>
                                        ...
                                        @foreach ($students as $student)
                                            <option value="{{ $student->id }}"> {{ $student->dni }} |
                        ...
                        <div class="form-check form-switch d-flex align-items-center mb-3">
                            <input name="student_active" class="form-check-input" type="checkbox"
                                id="activeSectionStudent">
                            <label class="form-check-label mt-1 mb-0 ms-3" for="activeSectionStudent"> Estudiante activo
                            </label>
                        </div>
    ...
    <div class="modal fade" id="SectionUpdateStudentModal" tabindex="-1" aria-labelledby="SectionUpdateStudentModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-gradient-primary">
                ...
                <form role="form" id='SectionStudentUpdate-form' class="text-start alertEdits" method="POST"
                    action="">
                    @method('PATCH')
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-check form-switch d-flex align-items-center mb-3">
                            <input name="student_active" class="form-check-input activeSectionStudent" type="checkbox"
                                id="activeSectionStudent">
                            <label class="form-check-label mt-1 mb-0 ms-3" for="activeSectionStudent"> Estudiante activo
                            </label>
                        </div>
    ...
    <div class="modal fade" id="ModRegSecSubject" tabindex="-1" aria-labelledby="ModRegSecSubject" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form role="form" class="text-start" method="POST"
                    action="{{ route('sections.registerSubject', $section) }}">
                    @csrf
    ...
    <div class="modal fade" id="SectionUpdateSubjectModal" tabindex="-1" aria-labelledby="SectionUpdateSubjectModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-gradient-primary">
                ...
                <form role="form" id='SectionSubjectUpdate-form' class="text-start alertEdits" method="POST"
                    action="">
                    @method('PATCH')
                    @csrf
                    <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary mx-2" data-bs-dismiss="modal">Cerrar</button>
                        <button type="submit" value="Confirmar" id="btn-submit-updateSubjectSection"
