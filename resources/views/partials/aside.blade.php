    ...
    @if ($role == 'Admin')
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="{{ route('data.index') }}">
                <img src="{{ asset('assets/img/login-bg/logo-magister.png') }}" class="navbar-brand-img h-100"
                    alt="main_logo">
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white {{ setActive('sections.*') }}"
                        href="{{ route('sections.principalIndex') }}">
                        <div class="text-white text-center ms-1 me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white {{ setActive('assessment.*') }}"
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white " href="{{ route('teacherView.index') }}">
                                <div
                                    class="text-white text-center ms-1 me-2 d-flex align-items-center justify-content-center">
                                    <i class="fa-solid fa-cubes"></i>
                                </div>
                                <span class="nav-link-text ms-1">Secciones</span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white {{ setActive('user.profile') }}"
