                ...
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 mt-n4">
                            <h5 class="text-white text-capitalize text-center">{{ $student->name }} {{ $student->lastname }}
                            </h5>
                        </div>
                        <br>
                        ...
                        <a href="{{ route('students.index') }}" class="btn btn-primary"><i
                                class="fa-solid fa-chevron-left"></i> &nbsp; Volver</a>
                    </div>
                    <br>
                </div>
            </div>
