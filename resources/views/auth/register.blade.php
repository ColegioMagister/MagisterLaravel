					...
					<div class="col-lg-6 col-md-8 col-12 mx-auto">
						<div class="card z-index-0 fadeIn3 fadeInBottom">
							<div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
								...
								<div class="box-wlc border-radius-lg py-1 pe-1">
									<img src="assets/img/login-bg/bg-right1.jpg" alt="">
									<h4 class="text-white font-weight-bolder text-center mt-3 mb-4">REGISTRO</h4>
									<h6 class="text-white font-weight-light text-center mb-2">Ingrese sus datos</h6>
								...
								<form role="form" class="text-start" method="POST" action="{{ route('register') }}">
									...
									<div class="input-group input-group-outline mb-3">
										<select name="id_employee" id="id_employee">
											...
											<option value="{{$employee->id}}"> {{$employee->id}} - {{$employee->name}}
