...
<body>
    @foreach ($schools as $school)
      ...
      {{ base64_encode(file_get_contents(base_path('public/' . $school->url_img))) }}">
        ...
        <img class="img2"
            src="https://yt3.googleusercontent.com/7EElj11xPg9EqaAFGIHPBMTp715eVFKSqVnsu2BgsMs6l-HaWAek46rHizWizs38MNEmJgRzKSA=s900-c-k-c0x00ffffff-no-rj">
        <div>
        ...
        <div class="footer">
            <p>Este reporte de alumnos es proporcionado por la Institucion Educativa Privada {{ $school->school_name }}.
            </p>
