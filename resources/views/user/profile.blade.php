    ...
    <div class="col-xl-9">
      <div class="card-header p-3 pt-2">
        ...
        <div class="col text-center" style= "display:flex;">
          <img class=" img img-fluid text-start m-5" src="/{{ Auth::user()->employee->url_img}}" style= "width: 30%; height: 20%; border-radius: 8%;">
          <div class="contenedor" style= padding:7%;>
            ...
            <div class="col text-center">
              <a href="{{route('user.editprofile')}}" class="btn btn-success"><i class="fa-solid fa-pencil fa-xl"></i> &nbsp; Modificar usuario</a>
            </div>
